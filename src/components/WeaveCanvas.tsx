...
export function WeaveCanvas() {
  ...
  useEffect(() => {
    const down = (event: KeyboardEvent) => {
      ...
      const shortcuts: Record<string, typeof activeTool> = { v: "select", a: "direct", r: "rectangle", p: "polygon", b: "brush", e: "eraser", l: "transition", g: "gradient", h: "pan" };
      ...
      if ((event.key === "Delete" || event.key === "Backspace") && selectedRegionId) state.deleteRegion(selectedRegionId);
  ...
  }, [activeTool, finishPolygon, selectedRegionId, state]);
